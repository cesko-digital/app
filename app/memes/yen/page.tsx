...
const dataSchema = z.object({
  question: z
    .string()
    .transform((val) =>
      !val || val === "" ? "Jsme už digitálním státem?" : val,
    ),
  answer: z
    .string()
    .transform((val) => (!val || val === "" ? "Bylo to na Slacku." : val)),
});

export default function Home() {
  const [data, setData] = useState<z.infer<typeof dataSchema>>({
    question: "Jsme už digitálním státem?",
    answer: "Bylo to na Slacku.",
  });
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-8 pt-16">
      <img
        ...
        src={`/api/memes/yen?question=${encodeURIComponent(
          data.question,
      ...
      >
        ...
        <input
          ...
          {...register("question")}
          placeholder="Jsme už digitálním státem?"
        />
