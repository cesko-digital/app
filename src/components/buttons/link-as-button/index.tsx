...
export interface LinkAsButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement>, Partial<StyledLinkProps> {
  children: React.ReactChild
}

const LinkAsButton: React.FC<LinkAsButtonProps> = ({ children, size = ButtonSize.Normal, ...rest }: LinkAsButtonProps) => (
